...
export function proxy(req: NextRequest) {
  ...
  const cspHeader = [
    "default-src 'self';",
    `script-src 'self' 'nonce-${nonce}' 'strict-dynamic' 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ""} https://checkout.razorpay.com https://cdn.razorpay.com https://va.vercel-insights.com;`,
    `style-src 'self' 'unsafe-inline';`,
    "img-src 'self' data: blob: https://res.cloudinary.com https://lh3.googleusercontent.com;",
    "connect-src 'self' ws: wss: https://api.razorpay.com https://checkout.razorpay.com https://lumberjack.razorpay.com https://va.vercel-insights.com https://api.cloudinary.com;",
