...
export default function ProductDetail({ initialProduct, reviewStats = { avgRating: 0, count: 0 } }) {
              ...
              <div className="space-y-3">
                ...
                {reviewStats.count > 0 && (
                  <div className="flex items-center gap-2 pt-1">
                    <StarRating rating={Math.round(reviewStats.avgRating)} size={16} />
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 font-montserrat text-[11px] text-gold/80 hover:text-gold tracking-wider uppercase font-semibold transition-colors pt-1"
                >
